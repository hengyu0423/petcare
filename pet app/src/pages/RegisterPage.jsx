    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">建立新帳號</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-semibold text-gray-600 mb-1.5 uppercase tracking-wide">姓名</label>
        ...
        <p className="text-center text-sm text-gray-400 mt-6">
          已有帳號？{' '}
          <Link to="/login" className="text-green-500 font-semibold hover:underline">返回登入</Link>
        </p>
      </div>
    </div>
  )
